...
var secondPlayerColor = "white"; //"rgb(0, 0, 0)";	    //black
...
////events
$("#menu").click(ShowMenu);
$("#newGame").click(ShowNewGameMenu);
$("#options").click(ShowOptionsMenu);
$(".back").click(ShowMainMenu);
$(".resume").click(HideMenu);
...
function Animate(color) {
	...
	setTimeout(GameOverCheck, 1100, row, col, true);
...
function AnimateGameOver(x1, y1, x2, y2, horizontal, vertical) {
	if(animation) {
		setTimeout(AnimateGameOver, 250, x1, y1, x2, y2, horizontal, vertical);
	}
	//horizontal
...
function ChangeStyle() {
	var newStyle = $(this).val() + ".css";
	newStyle = "http://stringbitking.hostbg.net/wp-content/themes/spectacular/" + newStyle;
	$("#styleLink").attr("href", newStyle);
}